<div class="min-h-screen flex items-center justify-center px-4 py-12">
    ...
    <div class="w-full max-w-md fade-up">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold mt-2 text-slate-900 dark:text-white">Welcome back</h1>
            <p class="text-sm mt-1 text-slate-500">Sign in to your account to continue</p>
        </div>
        ...
        <p class="mt-6 text-center text-sm text-slate-500">
            ...
            <a href="/register" class="font-semibold text-red-500 hover:text-red-400 transition">Create one for free</a>
        </p>
